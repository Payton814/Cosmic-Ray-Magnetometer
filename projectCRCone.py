...
def projectCRCone(sc, CR_r0, CR_dir, R = 25362, mask = True):
    ...
    outerCone = f(sc_x, sc_y, sc_z, CR_r0[:,0], CR_r0[:,1], CR_r0[:,2], (0.4 + 0.01)*np.pi/180, CR_theta, CR_phi)
    innerCone = f(sc_x, sc_y, sc_z, CR_r0[:,0], CR_r0[:,1], CR_r0[:,2], (0.4 - 0.01)*np.pi/180, CR_theta, CR_phi)
